"""
Django settings for ams_web project.
...
SECRET_KEY = 't&=p0!!c-7zb7o1=sk!en7z&-18t1v5@da!c1(c201evn0ql(j'
...
WSGI_APPLICATION = 'ams_web.wsgi.application'
